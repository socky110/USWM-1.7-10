...
public class bls extends LightSaber{
	public String name = "uswm:bls";
	public bls(){
		this.setUnlocalizedName("bls");
	}
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        p_77615_3_.inventory.addItemStackToInventory(new ItemStack(uswm.bluelightsaber));
